...
// 	"gitlab.com/oiacow/nextfesl/inter/fesl/pnow"
// 	"gitlab.com/oiacow/nextfesl/inter/fesl/rank"
...
// 	startPacket := &codec.Command{
// 		Message: codec.Fields{
// 			"TXN": `Start`,
...
// 	rankCtrl.UpdateStats(network.EventClientCommand{client, rankUpdateStats})

// 	// 21:47:23 : [09:47:23 PM] <-N req pnow 0xc000000d {id.partition=/eagames/bfwest-dedicated, TXN=Start, id.id=1}
// 	pnowCtrl.Start(network.EventClientCommand{client, startPacket})
...
// 	pnowCtrl.Status(network.EventClientCommand{client, startPacket})

// 	// 21:47:23 : [09:47:23 PM] ->N GDAT 0x40000000 {LID=1, GID=7, TID=3}
// 	gdatPacket := &codec.Command{
// 		Message: codec.Fields{
// 			"LID": `1`,
// 			"GID": `7`,
// 			"TID": `3`,
...
// 	thtrCtrl.GameData(network.EventClientCommand{client, gdatPacket})
...
// 	thtrCtrl.EnterGame(network.EventClientCommand{client, egamPacket})
...
// 	// )
// 	// thtrCtrl.EGEG(&network.EventClientCommand{client, egegPacket}, gameID, lobbyID, ticket)
// }
