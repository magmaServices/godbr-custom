...
import (
	...
	"testing"
	"time"
	"gitlab.com/oiacow/nextfesl/inter/fesl/acct"
	"gitlab.com/oiacow/nextfesl/inter/fesl/fsys"
	"gitlab.com/oiacow/nextfesl/inter/fesl/gsum"
	"gitlab.com/oiacow/nextfesl/inter/fesl/rank"
	"gitlab.com/oiacow/nextfesl/network"
	"gitlab.com/oiacow/nextfesl/network/codec"
	"gitlab.com/oiacow/nextfesl/storage/database/dbtest"
)
...
func createEventCommand(client *network.Client, payload codec.Fields) network.EventClientCommand {
	return network.EventClientCommand{
		Client: client,
...
func createCommand(payload []byte) *codec.Command {
	return &codec.Command{Message: codec.DecodeFESL(payload)}
}
...
func TestServerLogin(t *testing.T) {
	...
	fsysCtrl.Hello(client, &codec.Command{Message: codec.Fields{
		"TXN":             `Hello`,
...
func TestClientLogin(t *testing.T) {
	...
	fsysHello := &codec.Command{Message: codec.Fields{
		"TXN":             `Hello`,
		"clientString":    `bfwest-pc`,
		"sku":             `125170`,
		"locale":          `en_US`,
